...
<x-adminlte-card>
    <form action="{{ url('/balita') }}" method="POST">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" value="{{old('namaOrtu')}}" name='namaOrtu'>
                @error('namaOrtu')
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" value="{{old('rt')}}" class="form-control @error('rt') is-invalid @enderror"
                    name='rt'>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" value="{{old('rw')}}" class="form-control @error('rw') is-invalid @enderror"
                    name='rw'>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <textarea cols="3" class="form-control @error('alamat') is-invalid @enderror"
